...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { addrbound_read { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln1379 \
    op interface \
    ports { sext_ln1379 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata \
    op interface \
    ports { ldata_dout { I 512 vector } ldata_num_data_valid { I 3 vector } ldata_fifo_cap { I 3 vector } ldata_empty_n { I 1 bit } ldata_read { O 1 bit } } \
} "
}
...
set InstName cvtcolor_og_flow_control_loop_pipe_sequential_init_U
set CompName cvtcolor_og_flow_control_loop_pipe_sequential_init
