...
set portList { 
	...
	{ imgOutput0_data_dout sc_in sc_lv 8 signal 0 } 
	{ imgOutput0_data_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ imgOutput0_data_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ imgOutput0_data_empty_n sc_in sc_logic 1 signal 0 } 
	{ imgOutput0_data_read sc_out sc_logic 1 signal 0 } 
	{ ldata_din sc_out sc_lv 512 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput0_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_16ns_16ns_32_1_1_U96", "Parent" : "0"}]}
