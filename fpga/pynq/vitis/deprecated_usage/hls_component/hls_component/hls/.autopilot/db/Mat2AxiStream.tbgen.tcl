...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "7", "8", "9"],
		...
		"Port" : [
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "imgOutput0_data"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_2_U0", "Parent" : "0", "Child" : ["4", "6"],
		...
		"Port" : [
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput0_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_2_U0.mul_16ns_16ns_32_1_1_U96", "Parent" : "3"},
...
set Spec2ImplPortList { 
	imgOutput0_data { ap_fifo {  { imgOutput0_data_dout fifo_data_in 0 8 }  { imgOutput0_data_empty_n fifo_status 0 1 }  { imgOutput0_data_read fifo_port_we 1 1 } } }
	ldata { ap_fifo {  { ldata_din fifo_data_in 1 512 }  { ldata_full_n fifo_status 0 1 }  { ldata_write fifo_port_we 1 1 } } }
