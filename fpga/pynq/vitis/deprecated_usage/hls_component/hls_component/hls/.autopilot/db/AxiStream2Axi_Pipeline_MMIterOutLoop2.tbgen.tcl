...
set C_modelArgMapList {[ 
	{ "Name" : "addrbound_read", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln1379", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ addrbound_read sc_in sc_lv 16 signal 0 } 
	{ sext_ln1379 sc_in sc_lv 58 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1379", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln1379", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "32403"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "32403"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln1379 { ap_none {  { sext_ln1379 in_data 0 58 } } }
