set moduleName xfMat2Array_512_0_1080_1920_1_2_1_s
set isTopModule 0
...
set C_modelName {xfMat2Array<512, 0, 1080, 1920, 1, 2, 1>}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_read int 32 regular  }
	{ p_read1 int 32 regular  }
	{ imgOutput0_data int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "imgOutput0_data", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ imgOutput0_data_dout sc_in sc_lv 8 signal 2 } 
	{ imgOutput0_data_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ imgOutput0_data_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ imgOutput0_data_empty_n sc_in sc_logic 1 signal 2 } 
	{ imgOutput0_data_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "imgOutput0_data_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "imgOutput0_data", "role": "dout" }} , 
 	...
 	{ "name": "imgOutput0_data_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgOutput0_data", "role": "empty_n" }} , 
 	{ "name": "imgOutput0_data_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgOutput0_data", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_60", "Port" : "imgOutput0_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_60", "Port" : "gmem2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60", "Parent" : "0", "Child" : ["2", "3", "5", "6", "16", "19", "20", "21", "22"],
		"CDFG" : "Mat2Axi",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		...
		"Port" : [
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Mat2AxiStream_U0", "Port" : "imgOutput0_data"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.entry_proc4_U0", "Parent" : "1",
		"CDFG" : "entry_proc4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.addrbound_U0", "Parent" : "1", "Child" : ["4"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.addrbound_U0.mul_16ns_16ns_32_3_1_U77", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2Axi_Block_entry24_proc_U0", "Parent" : "1",
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0", "Parent" : "1", "Child" : ["7", "8", "9", "13", "14", "15"],
		"CDFG" : "Mat2AxiStream",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		...
		"Port" : [
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "imgOutput0_data"}]},
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.entry_proc_U0", "Parent" : "6",
		"CDFG" : "entry_proc",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.last_blk_pxl_width_1_U0", "Parent" : "6",
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.MatStream2AxiStream_2_U0", "Parent" : "6", "Child" : ["10", "12"],
		...
		"Port" : [
			{"Name" : "imgOutput0_data", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput0_data", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["16"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "10", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Parent" : "9", "Child" : ["11"],
	...
	{"ID" : "11", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.flow_control_loop_pipe_sequential_init_U", "Parent" : "10"},
	{"ID" : "12", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.mul_16ns_16ns_32_1_1_U96", "Parent" : "9"},
	{"ID" : "13", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.rows_c_U", "Parent" : "6"},
	{"ID" : "14", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.cols_c_U", "Parent" : "6"},
	{"ID" : "15", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.Mat2AxiStream_U0.last_blk_width_channel_U", "Parent" : "6"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.AxiStream2Axi_U0", "Parent" : "1", "Child" : ["17"],
		"CDFG" : "AxiStream2Axi",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6","9"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_71", "Port" : "ldata", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_71", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			...
			{"Name" : "addrbound_read", "Type" : "None", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "1"}]},
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.AxiStream2Axi_U0.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_71", "Parent" : "16", "Child" : ["18"],
	...
	{"ID" : "18", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.AxiStream2Axi_U0.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_71.flow_control_loop_pipe_sequential_init_U", "Parent" : "17"},
	{"ID" : "19", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.dout_c_U", "Parent" : "1"},
	{"ID" : "20", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.p_channel_U", "Parent" : "1"},
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.axibound_U", "Parent" : "1"},
	{"ID" : "22", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_60.ldata_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "17", "Max" : "2073610"}
	, {"Name" : "Interval", "Min" : "17", "Max" : "2073610"}
]}
...
set Spec2ImplPortList { 
	...
	imgOutput0_data { ap_fifo {  { imgOutput0_data_dout fifo_data_in 0 8 }  { imgOutput0_data_num_data_valid fifo_status_num_data_valid 0 3 }  { imgOutput0_data_fifo_cap fifo_update 0 3 }  { imgOutput0_data_empty_n fifo_status 0 1 }  { imgOutput0_data_read fifo_port_we 1 1 } } }
