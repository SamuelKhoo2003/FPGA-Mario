...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput0_data_din { O 24 vector } imgInput0_data_num_data_valid { I 3 vector } imgInput0_data_fifo_cap { I 3 vector } imgInput0_data_full_n { I 1 bit } imgInput0_data_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 60 \
    name imgInput0_rows_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_imgInput0_rows_c \
    op interface \
    ports { imgInput0_rows_c_din { O 32 vector } imgInput0_rows_c_num_data_valid { I 3 vector } imgInput0_rows_c_fifo_cap { I 3 vector } imgInput0_rows_c_full_n { I 1 bit } imgInput0_rows_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 61 \
    name imgInput0_cols_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_imgInput0_cols_c \
    op interface \
    ports { imgInput0_cols_c_din { O 32 vector } imgInput0_cols_c_num_data_valid { I 3 vector } imgInput0_cols_c_fifo_cap { I 3 vector } imgInput0_cols_c_full_n { I 1 bit } imgInput0_cols_c_write { O 1 bit } } \
} "
}
