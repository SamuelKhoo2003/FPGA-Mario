...
set name cvtcolor_og_mul_8ns_15ns_22_1_1
...
set id 63
set name cvtcolor_og_mac_muladd_8ns_12ns_22ns_22_4_1
...
set ce_signed 0
set out_width 22
set arg_lists {i0 {8 0 +} i1 {12 0 +} m {20 0 +} i2 {22 0 +} p {22 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 64
set name cvtcolor_og_mac_muladd_8ns_15ns_22ns_23_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 23
set arg_lists {i0 {8 0 +} i1 {15 0 +} m {23 1 +} i2 {22 0 +} p {23 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3 ALLOW_PRAGMA 1
}
