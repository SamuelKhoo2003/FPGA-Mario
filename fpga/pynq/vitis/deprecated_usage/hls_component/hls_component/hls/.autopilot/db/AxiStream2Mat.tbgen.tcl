...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "7", "8", "9"],
		...
		"Port" : [
			...
			{"Name" : "imgInput0_data", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "AxiStream2MatStream_2_U0", "Port" : "imgInput0_data"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AxiStream2MatStream_2_U0", "Parent" : "0", "Child" : ["4", "6"],
		...
		"Port" : [
			...
			{"Name" : "imgInput0_data", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_58", "Port" : "imgInput0_data", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.AxiStream2MatStream_2_U0.mul_32s_32s_32_2_1_U32", "Parent" : "3"},
...
set Spec2ImplPortList { 
	ldata { ap_fifo {  { ldata_dout fifo_data_in 0 512 }  { ldata_empty_n fifo_status 0 1 }  { ldata_read fifo_port_we 1 1 } } }
