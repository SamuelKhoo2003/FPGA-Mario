...
set C_modelArgList {
	...
	{ ldata int 512 regular {fifo 1 volatile }  }
	{ localbuffer_out int 512 regular {pointer 1}  }
	{ filled_out int 10 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ldata", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "localbuffer_out", "interface" : "wire", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "filled_out", "interface" : "wire", "bitwidth" : 10, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ imgOutput0_data_dout sc_in sc_lv 8 signal 5 } 
	{ imgOutput0_data_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ imgOutput0_data_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ imgOutput0_data_empty_n sc_in sc_logic 1 signal 5 } 
	{ imgOutput0_data_read sc_out sc_logic 1 signal 5 } 
	{ ldata_din sc_out sc_lv 512 signal 6 } 
	...
	{ localbuffer_out sc_out sc_lv 512 signal 7 } 
	{ localbuffer_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ filled_out sc_out sc_lv 10 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ldata_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "ldata", "role": "din" }} , 
 	...
 	{ "name": "localbuffer_out", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "localbuffer_out", "role": "default" }} , 
 	...
 	{ "name": "filled_out", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "filled_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	ldata { ap_fifo {  { ldata_din fifo_data_in 1 512 }  { ldata_num_data_valid fifo_status_num_data_valid 0 3 }  { ldata_fifo_cap fifo_update 0 3 }  { ldata_full_n fifo_status 0 1 }  { ldata_write fifo_port_we 1 1 } } }
	localbuffer_out { ap_vld {  { localbuffer_out out_data 1 512 }  { localbuffer_out_ap_vld out_vld 1 1 } } }
	filled_out { ap_vld {  { filled_out out_data 1 10 }  { filled_out_ap_vld out_vld 1 1 } } }
}
