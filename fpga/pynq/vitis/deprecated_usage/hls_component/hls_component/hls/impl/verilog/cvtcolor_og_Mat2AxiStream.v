...
module cvtcolor_og_Mat2AxiStream (
...
wire    MatStream2AxiStream_2_U0_imgOutput0_data_read;
wire   [511:0] MatStream2AxiStream_2_U0_ldata_din;
...
cvtcolor_og_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_MatStream2AxiStream_2_s MatStream2AxiStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_fifo_w16_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w32_d3_S_x cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w4_d2_S_x last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign imgOutput0_data_read = MatStream2AxiStream_2_U0_imgOutput0_data_read;
...
endmodule //cvtcolor_og_Mat2AxiStream
