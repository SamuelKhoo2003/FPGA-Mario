...
module cvtcolor_og_Array2xfMat_512_16_1080_1920_1_2_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        imgInput0_rows_c_din,
        imgInput0_rows_c_num_data_valid,
        imgInput0_rows_c_fifo_cap,
        imgInput0_rows_c_full_n,
        imgInput0_rows_c_write,
        imgInput0_cols_c_din,
        imgInput0_cols_c_num_data_valid,
        imgInput0_cols_c_fifo_cap,
        imgInput0_cols_c_full_n,
        imgInput0_cols_c_write
);
...
output  [31:0] imgInput0_rows_c_din;
input  [2:0] imgInput0_rows_c_num_data_valid;
input  [2:0] imgInput0_rows_c_fifo_cap;
input   imgInput0_rows_c_full_n;
output   imgInput0_rows_c_write;
output  [31:0] imgInput0_cols_c_din;
input  [2:0] imgInput0_cols_c_num_data_valid;
input  [2:0] imgInput0_cols_c_fifo_cap;
input   imgInput0_cols_c_full_n;
output   imgInput0_cols_c_write;
...
reg imgInput0_rows_c_write;
reg imgInput0_cols_c_write;
...
reg    imgInput0_rows_c_blk_n;
reg    imgInput0_cols_c_blk_n;
reg    ap_block_state1;
...
wire   [511:0] grp_Axi2Mat_fu_82_m_axi_gmem1_WDATA;
wire   [63:0] grp_Axi2Mat_fu_82_m_axi_gmem1_WSTRB;
...
wire   [23:0] grp_Axi2Mat_fu_82_imgInput0_data_din;
wire    grp_Axi2Mat_fu_82_imgInput0_data_write;
...
cvtcolor_og_Axi2Mat grp_Axi2Mat_fu_82(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) | ((ap_sync_grp_Axi2Mat_fu_82_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        imgInput0_cols_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        imgInput0_cols_c_write = 1'b1;
    end else begin
        imgInput0_cols_c_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        imgInput0_rows_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        imgInput0_rows_c_write = 1'b1;
    end else begin
        imgInput0_rows_c_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (ap_done_reg == 1'b1) | (imgInput0_cols_c_full_n == 1'b0) | (imgInput0_rows_c_full_n == 1'b0));
end
...
assign imgInput0_cols_c_din = p_read1;

assign imgInput0_data_din = grp_Axi2Mat_fu_82_imgInput0_data_din;

assign imgInput0_rows_c_din = p_read;
...
endmodule //cvtcolor_og_Array2xfMat_512_16_1080_1920_1_2_s
