...
module cvtcolor_og_AxiStream2Mat (
        ldata_dout,
        ldata_empty_n,
        ldata_read,
        imgInput0_data_din,
...
wire   [23:0] AxiStream2MatStream_2_U0_imgInput0_data_din;
wire    AxiStream2MatStream_2_U0_imgInput0_data_write;
...
cvtcolor_og_entry_proc3 entry_proc3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc3_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);
...
assign imgInput0_data_din = AxiStream2MatStream_2_U0_imgInput0_data_din;

assign imgInput0_data_write = AxiStream2MatStream_2_U0_imgInput0_data_write;
...
endmodule //cvtcolor_og_AxiStream2Mat
