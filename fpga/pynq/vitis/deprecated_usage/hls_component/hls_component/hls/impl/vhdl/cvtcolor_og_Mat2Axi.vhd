...
architecture behav of cvtcolor_og_Mat2Axi is 
...
attribute shreg_extract : string;
    ...
    signal addrbound_U0_p_channel : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Mat2Axi_Block_entry24_proc_U0_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal axibound_full_n : STD_LOGIC;
    signal Mat2AxiStream_U0_imgOutput0_data_read : STD_LOGIC;
    signal Mat2AxiStream_U0_ldata_din : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal axibound_dout : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component cvtcolor_og_entry_proc4 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cvtcolor_og_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cvtcolor_og_Mat2Axi_Block_entry24_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_1 : IN STD_LOGIC_VECTOR (15 downto 0);
        ap_return : OUT STD_LOGIC_VECTOR (15 downto 0) );
    end component;


    component cvtcolor_og_Mat2AxiStream IS
    port (
        imgOutput0_data_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        imgOutput0_data_empty_n : IN STD_LOGIC;
        imgOutput0_data_read : OUT STD_LOGIC;
    ...
    component cvtcolor_og_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component cvtcolor_og_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component cvtcolor_og_fifo_w16_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component cvtcolor_og_fifo_w512_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc4_U0 : component cvtcolor_og_entry_proc4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    addrbound_U0 : component cvtcolor_og_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_entry24_proc_U0 : component cvtcolor_og_Mat2Axi_Block_entry24_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component cvtcolor_og_Mat2AxiStream
    port map (
        imgOutput0_data_dout => imgOutput0_data_dout,
        imgOutput0_data_empty_n => imgOutput0_data_empty_n,
        imgOutput0_data_read => Mat2AxiStream_U0_imgOutput0_data_read,
    ...
    AxiStream2Axi_U0 : component cvtcolor_og_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component cvtcolor_og_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    p_channel_U : component cvtcolor_og_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_U : component cvtcolor_og_fifo_w16_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component cvtcolor_og_fifo_w512_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= AxiStream2Axi_U0_ap_done;
    ap_idle <= ((axibound_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and entry_proc4_U0_ap_idle and addrbound_U0_ap_idle and Mat2Axi_Block_entry24_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
