...
entity cvtcolor_og_start_for_AxiStream2Mat_U0 is 
    generic (
...
architecture rtl of cvtcolor_og_start_for_AxiStream2Mat_U0 is

    component cvtcolor_og_start_for_AxiStream2Mat_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_cvtcolor_og_start_for_AxiStream2Mat_U0_ShiftReg : cvtcolor_og_start_for_AxiStream2Mat_U0_ShiftReg
    generic map (
...
entity cvtcolor_og_start_for_AxiStream2Mat_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end cvtcolor_og_start_for_AxiStream2Mat_U0_ShiftReg;

architecture rtl of cvtcolor_og_start_for_AxiStream2Mat_U0_ShiftReg is
