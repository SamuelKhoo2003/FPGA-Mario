...
wire   [511:0] Axi2AxiStream_U0_ldata_din;
...
wire   [23:0] AxiStream2Mat_U0_imgInput0_data_din;
wire    AxiStream2Mat_U0_imgInput0_data_write;
...
cvtcolor_og_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_AxiStream2Mat AxiStream2Mat_U0(
...
cvtcolor_og_fifo_w512_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_start_for_AxiStream2Mat_U0 start_for_AxiStream2Mat_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign imgInput0_data_din = AxiStream2Mat_U0_imgInput0_data_din;

assign imgInput0_data_write = AxiStream2Mat_U0_imgInput0_data_write;
