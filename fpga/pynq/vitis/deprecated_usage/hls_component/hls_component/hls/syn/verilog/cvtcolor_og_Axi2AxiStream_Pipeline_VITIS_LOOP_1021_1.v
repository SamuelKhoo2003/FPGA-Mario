...
module cvtcolor_og_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input   ldata_full_n;
output   ldata_write;
input  [17:0] cols_addrbound;
input  [57:0] sext_ln1021;
...
reg   [511:0] gmem1_addr_read_reg_133;
reg   [17:0] c_fu_54;
wire   [17:0] c_2_fu_100_p2;
wire    ap_loop_init;
reg   [17:0] ap_sig_allocacmp_c_1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1021_fu_94_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1021_fu_94_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign c_2_fu_100_p2 = (ap_sig_allocacmp_c_1 + 18'd1);

assign icmp_ln1021_fu_94_p2 = ((ap_sig_allocacmp_c_1 == cols_addrbound) ? 1'b1 : 1'b0);

assign ldata_din = gmem1_addr_read_reg_133;
...
endmodule //cvtcolor_og_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1
