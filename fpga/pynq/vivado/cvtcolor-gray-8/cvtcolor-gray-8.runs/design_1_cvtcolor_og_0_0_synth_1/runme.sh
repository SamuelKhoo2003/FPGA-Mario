...
HD_PWD='W:/vivado/cvtcolor-gray-8/cvtcolor-gray-8.runs/design_1_cvtcolor_og_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cvtcolor_og_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cvtcolor_og_0_0.tcl
