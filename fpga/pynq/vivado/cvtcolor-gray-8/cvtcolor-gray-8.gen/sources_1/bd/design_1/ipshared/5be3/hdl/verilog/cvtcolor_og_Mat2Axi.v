...
wire   [15:0] addrbound_U0_p_channel;
...
wire   [15:0] Mat2Axi_Block_entry24_proc_U0_ap_return;
wire    axibound_full_n;
wire    Mat2AxiStream_U0_imgOutput0_data_read;
wire   [511:0] Mat2AxiStream_U0_ldata_din;
...
cvtcolor_og_entry_proc4 entry_proc4_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_Mat2Axi_Block_entry24_proc Mat2Axi_Block_entry24_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_Mat2AxiStream Mat2AxiStream_U0(
...
cvtcolor_og_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cvtcolor_og_fifo_w64_d4_S dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w16_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w16_d2_S axibound_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
cvtcolor_og_fifo_w512_d2_S_x ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = ((axibound_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & entry_proc4_U0_ap_idle & addrbound_U0_ap_idle & Mat2Axi_Block_entry24_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);
...
assign imgOutput0_data_read = Mat2AxiStream_U0_imgOutput0_data_read;
