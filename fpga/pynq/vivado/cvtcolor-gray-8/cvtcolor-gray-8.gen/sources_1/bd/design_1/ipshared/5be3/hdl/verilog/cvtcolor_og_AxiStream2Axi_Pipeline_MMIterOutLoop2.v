...
module cvtcolor_og_AxiStream2Axi_Pipeline_MMIterOutLoop2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [511:0] ldata_read_reg_137;
reg    ap_block_pp0_stage0_01001;
reg   [15:0] i_fu_56;
wire   [15:0] add_ln1379_fu_104_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1379_fu_98_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1379_fu_98_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln1379_fu_104_p2 = (ap_sig_allocacmp_i_1 + 16'd1);
...
assign icmp_ln1379_fu_98_p2 = ((ap_sig_allocacmp_i_1 == addrbound_read) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = ldata_read_reg_137;
...
endmodule //cvtcolor_og_AxiStream2Axi_Pipeline_MMIterOutLoop2
