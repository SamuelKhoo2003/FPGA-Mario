...
module threshold_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] gmem1_addr_read_reg_131;
reg   [21:0] c_fu_56;
wire   [21:0] c_2_fu_98_p2;
wire    ap_loop_init;
reg   [21:0] ap_sig_allocacmp_c_1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1021_fu_92_p2 == 1'd0))) begin
            c_fu_56 <= c_2_fu_98_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        gmem1_addr_read_reg_131 <= m_axi_gmem1_RDATA;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1021_fu_92_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign c_2_fu_98_p2 = (ap_sig_allocacmp_c_1 + 22'd1);

assign icmp_ln1021_fu_92_p2 = ((ap_sig_allocacmp_c_1 == mul_ln1021) ? 1'b1 : 1'b0);

assign ldata_din = gmem1_addr_read_reg_131;
...
endmodule //threshold_accel_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1
