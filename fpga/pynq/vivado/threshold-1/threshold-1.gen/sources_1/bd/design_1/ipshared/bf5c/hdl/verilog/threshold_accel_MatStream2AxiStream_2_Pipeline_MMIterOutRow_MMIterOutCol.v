...
module threshold_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        if (((icmp_ln1315_reg_446 == 1'd1) & (icmp_ln1301_reg_437 == 1'd0))) begin
            ap_phi_reg_pp0_iter3_val_1_reg_158 <= out_mat_data_dout;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        tmp_1_reg_480 <= sub_ln1332_fu_307_p2[32'd4];
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((ap_predicate_op43_read_state3 == 1'b1) & (out_mat_data_empty_n == 1'b0));
end
...
assign localbuffer_2_fu_361_p3 = ((tmp_1_reg_480[0:0] == 1'b1) ? shl_ln1332_fu_345_p2 : lshr_ln1332_fu_355_p2);
...
endmodule //threshold_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol
