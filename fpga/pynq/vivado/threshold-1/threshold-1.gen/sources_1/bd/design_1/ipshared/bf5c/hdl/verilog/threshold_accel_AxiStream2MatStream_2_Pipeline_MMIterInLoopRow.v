...
module threshold_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign j_3_fu_225_p3 = ((bLast_width_fu_209_p2[0:0] == 1'b1) ? 32'd0 : add_ln1086_fu_219_p2);
...
assign select_ln1071_3_fu_553_p3 = ((icmp_ln1071_reg_756_pp0_iter3_reg[0:0] == 1'b1) ? tmp_2_fu_544_p4 : shl_ln1071_reg_774);
...
assign select_ln1074_2_fu_388_p3 = ((icmp_ln1074_reg_713[0:0] == 1'b1) ? tmp_3_fu_373_p4 : val_fu_96);
...
always @ (shl_ln1071_reg_774) begin
    for (ap_tvar_int_0 = 8 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 7 - 0) begin
            tmp_2_fu_544_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_2_fu_544_p4[ap_tvar_int_0] = shl_ln1071_reg_774[7 - ap_tvar_int_0];
        end
    end
end
...
always @ (val_fu_96) begin
    for (ap_tvar_int_1 = 8 - 1; ap_tvar_int_1 >= 0; ap_tvar_int_1 = ap_tvar_int_1 - 1) begin
        if (ap_tvar_int_1 > 7 - 0) begin
            tmp_3_fu_373_p4[ap_tvar_int_1] = 1'b0;
        end else begin
            tmp_3_fu_373_p4[ap_tvar_int_1] = val_fu_96[7 - ap_tvar_int_1];
        end
    end
end
...
endmodule //threshold_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow
