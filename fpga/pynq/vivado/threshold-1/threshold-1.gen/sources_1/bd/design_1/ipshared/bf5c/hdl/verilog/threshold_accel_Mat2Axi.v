...
wire    Mat2AxiStream_U0_out_mat_data_read;
...
threshold_accel_Mat2AxiStream Mat2AxiStream_U0(
    ...
    .out_mat_data_read(Mat2AxiStream_U0_out_mat_data_read),
...
threshold_accel_fifo_w22_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w22_d2_S axibound_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w8_d2_S_x ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign out_mat_data_read = Mat2AxiStream_U0_out_mat_data_read;
